...
const Home = () => {
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      <img
        className="w-16 absolute left-5 top-35"
        src={uberLogo}
        alt="uber-logo"
      />
      ...
      <div
        ref={vehiclePanelRef}
        className="fixed z-10 bottom-0 w-full bg-white py-10 pt-12 translate-y-full"
      >
        <VehiclePanel
          setVehiclePanelOpen={setVehiclePanelOpen}
      ...
      <div
        ...
        className="fixed z-10 bottom-0 w-full bg-white px-3 py-6 pt-12  translate-y-full"
      >
        <ConformRide
          setConformRidePanel={setConformRidePanel}
      ...
      <div
        ...
        className="fixed z-10 bottom-0 w-full bg-white py-6 pt-12 "
      >
        <WaitingForDriver
